      ...
      <div className="overflow-x-auto">
        <table className="min-w-[1100px] w-full divide-y divide-slate-200">
          <thead className="bg-slate-50">
            <tr>
              <th className="px-3 py-3 text-left text-xs font-medium text-slate-600 whitespace-nowrap">
                採購單號
              </th>
              <th className="px-3 py-3 text-left text-xs font-medium text-slate-600 whitespace-nowrap">
                供應商
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {items.map((item) => (
              <tr key={item.lotId} className="hover:bg-slate-50/80">
                <td className="px-3 py-3 whitespace-nowrap text-sm font-mono text-slate-900">
                  {item.poNumber}
                </td>
                ...
                <td className="px-3 py-3 whitespace-nowrap">
                  <span className="font-mono text-sm bg-slate-100 px-2 py-1 rounded-md text-slate-900">
                ...
                <td className="px-3 py-3 whitespace-nowrap">
                  ...
                  {item.vendorDateCode && (
                    <div className="text-xs text-slate-500">DC: {item.vendorDateCode}</div>
                  )}
                </td>
