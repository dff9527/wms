...
import CreatePatternForm from './barcode/CreatePatternForm';
import DeletePatternDialog from './barcode/DeletePatternDialog';
import EditPatternDialog from './barcode/EditPatternDialog';
  ...
  return (
    <div className="flex flex-col gap-6 h-full p-6">
      ...
      <EditPatternDialog
        ...
        editPatternName={editPatternName}
        setEditPatternName={setEditPatternName}
        editRegex={editRegex}
        setEditRegex={setEditRegex}
        editFieldMapping={editFieldMapping}
        setEditFieldMapping={setEditFieldMapping}
