...
import { Package, Warehouse, TruckIcon, Search, BarChart3, ScanLine } from 'lucide-react';
       ...
       <Tabs value={activeTab} onValueChange={setActiveTab} className="size-full flex flex-col">
         <div className="bg-white border-b border-slate-200 px-6">
           <TabsList className="flex gap-1">
             ...
             <TabsTrigger value="barcode-rules" className="flex items-center gap-2 px-4 py-3 text-sm font-medium text-slate-600 hover:text-slate-900 border-b-2 border-transparent data-[state=active]:border-blue-600 data-[state=active]:text-blue-600 transition-colors"><ScanLine className="size-4" />條碼規則</TabsTrigger>
           </TabsList>
         </div>
